    ...
    If Validar(vMode) = True Then
        ...
        Select Case vMode
            Case 1 'nuevo
                ...
                cSQL = cSQL & " LOC_CODIGO, PRO_CODIGO, PAI_CODIGO,PROV_FANTASIA) "
                cSQL = cSQL & " VALUES "
            ...
            Case 2 'editar
                ...
                cSQL = cSQL & " ,PROV_FANTASIA=" & XS(txtNomFant.Text)
    ...
    If vMode <> 1 Then
        If vFieldID <> "0" Then
            ...
            If (rec.BOF And rec.EOF) = 0 Then
                ...
                txtNomFant.Text = ChkNull(rec!PROV_FANTASIA)
            Else
                Beep
...
Private Sub txtNomFant_Change()
    cmdAceptar.Enabled = True
End Sub

Private Sub txtNomFant_GotFocus()
    seltxt
End Sub

Private Sub txtNomFant_KeyPress(KeyAscii As Integer)
    KeyAscii = CarTexto(KeyAscii)
End Sub
