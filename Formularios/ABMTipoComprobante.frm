...
Begin VB.Form ABMTipoComprobante 
   ...
   Caption         =   "Datos del Tipo Comprobante..."
   ClientHeight    =   2565
   ClientLeft      =   2700
   ClientTop       =   2625
   ClientWidth     =   4530
   ...
   EndProperty
   Icon            =   "ABMTipoComprobante.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton cmdAyuda 
      Height          =   315
      Left            =   210
      Picture         =   "ABMTipoComprobante.frx":000C
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   2145
      Width           =   330
...
Const cTabla = "TIPO_COMPROBANTE"
Const cCampoID = "TCO_CODIGO"
Const cDesRegistro = "Tipo Comprobante"
...
Function SetMode(pMode As Integer)
    ...
    Select Case pMode
        Case 1
            ...
            Me.Caption = "Nuevo Tipo Comprobante..."
            txtID_LostFocus
            DesacCtrl txtID
        Case 2
            cmdAceptar.Enabled = False
            Me.Caption = "Editando Tipo Comprobante..."
            DesacCtrl txtID
        Case 3
            cmdAceptar.Visible = False
            Me.Caption = "Datos del Tipo Comprobante..."
            DesacCtrl txtID
        Case 4
            cmdAceptar.Enabled = True
            Me.Caption = "Eliminando Tipo Comprobante..."
            DesacCtrl txtID
    End Select
    ...
    If Validar(vMode) = True Then
        ...
        Select Case vMode
            ...
            Case 4 'eliminar
                ...
                cSQL = "DELETE FROM " & cTabla & " WHERE TCO_CODIGO  = " & XN(txtID.Text)
