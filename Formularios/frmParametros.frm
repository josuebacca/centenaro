...
Begin VB.Form frmParametros 
   ...
   Begin TabDlg.SSTab TabDatos 
      ...
      Tab(0).Control(2)=   "FrmListCheques"
...
Private Sub cmdGrabar_Click()
    ...
    sql = sql & " ,IVA_2 =" & XS(txtotroIVA.Text)
    DBConn.Execute sql
...
Private Sub BuscarDatos()
    ...
    If rec.EOF = False Then
        ...
        txtotroIVA.Text = IIf(IsNull(rec!IVA_2), "", Format(rec!IVA_2, "0.00"))
    End If
    rec.Close
End Sub
