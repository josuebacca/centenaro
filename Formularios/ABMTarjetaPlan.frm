    ...
    If pMode <> 4 Then
        ...
        If txtID.Text = "" Then
            ...
            MsgBox "Falta información." & Chr(13) & _
                             "Ingrese la Identificación del Plan antes de aceptar.", vbCritical + vbOKOnly, App.Title
            txtID.SetFocus
            Exit Function
        ElseIf txtDescri.Text = "" Then
            Beep
            MsgBox "Falta información." & Chr(13) & _
                             "Ingrese la descripción del Plan antes de aceptar.", vbCritical + vbOKOnly, App.Title
            txtDescri.SetFocus
            Exit Function
    ...
    If vMode <> 1 Then
        If vFieldID <> "0" Then
            ...
            If (rec.BOF And rec.EOF) = 0 Then
                ...
                txtDescri.Text = Trim(ChkNull(rec!PLA_DESCRI))
                txtCuotas.Text = Trim(ChkNull(rec!PLA_CUOTAS))
            Else
                Beep
