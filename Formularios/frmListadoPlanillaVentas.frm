...
Begin VB.Form frmListadoPlanillaVentas 
   ...
   EndProperty
   Icon            =   "frmListadoPlanillaVentas.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame fraImpresion 
      ...
      Begin VB.PictureBox picSalida 
         ...
         Index           =   2
         Left            =   135
         Picture         =   "frmListadoPlanillaVentas.frx":0442
         ScaleHeight     =   240
         ScaleWidth      =   240
         TabIndex        =   14
         Top             =   315
      ...
      Begin VB.PictureBox picSalida 
         ...
         Index           =   1
         Left            =   135
         Picture         =   "frmListadoPlanillaVentas.frx":0544
         ScaleHeight     =   240
         ScaleWidth      =   240
         TabIndex        =   13
         Top             =   315
      ...
      Begin VB.PictureBox picSalida 
         ...
         Index           =   0
         Left            =   135
         Picture         =   "frmListadoPlanillaVentas.frx":0646
         ScaleHeight     =   240
         ScaleWidth      =   240
         TabIndex        =   12
         Top             =   315
      ...
      Begin VB.ComboBox cboDestino 
         Height          =   315
         ItemData        =   "frmListadoPlanillaVentas.frx":0748
         Left            =   450
         List            =   "frmListadoPlanillaVentas.frx":0755
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   270
         Width           =   1635
   ...
   End
End
Attribute VB_Name = "frmListadoPlanillaVentas"
...
Private Sub cboListar_Click()
    If frmListadoPlanillaVentas.Visible = True Then
...
'        If Rep.SelectionFormula = "" Then
'            Rep.SelectionFormula = " {FACTURA_CLIENTE.FCL_HORA}>= DATE( " & Mid(cboDesde.Text, 0, 2) & "," & Mid(cboDesde.Text, 4, 2) & "," & Mid(cboDesde.Text, 5, 2) & ")"
'        Else
'            Rep.SelectionFormula = Rep.SelectionFormula & " AND {FACTURA_CLIENTE.FCL_HORA}>= TIME( " & Mid(cboDesde.Text, 1, 2) & "," & Mid(cboDesde.Text, 4, 2) & ")'," & Mid(cboDesde.Text, 6, 2) & ")"
'        End If
'    End If
'    If cbohasta.ListIndex <> -1 Then
'        If Rep.SelectionFormula = "" Then
'            Rep.SelectionFormula = " {FACTURA_CLIENTE.FCL_HORA}<=DATE( " & Mid(cboDesde.Text, 0, 2) & "," & Mid(cboDesde.Text, 3, 2) & "," & Mid(cboDesde.Text, 5, 2) & ")"
'        Else
'            Rep.SelectionFormula = Rep.SelectionFormula & " AND {FACTURA_CLIENTE.FCL_HORA}<=TIME( " & Mid(cboDesde.Text, 1, 2) & "," & Mid(cboDesde.Text, 4, 2) & ")" ' & Mid(cboDesde.Text, 5, 2) & ")"
'        End If
'    End If
    ...
    Rep.WindowTitle = "Planilla de Ventas"
    Rep.ReportFileName = DRIVE & DirReport & "PlanillaVentas.rpt"
    Rep.Action = 1
End Sub

Private Sub CmdCancelar_Click()
    Set frmListadoPlanillaVentas = Nothing
