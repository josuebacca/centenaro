...
Begin VB.Form frmLibroIvaVentas 
   ...
   Begin VB.Frame FrameImpresora 
      ...
      Begin VB.ComboBox cboDestino 
         Height          =   315
         ItemData        =   "frmLibroIvaVentas.frx":0000
         Left            =   450
         List            =   "frmLibroIvaVentas.frx":000D
      ...
      Begin VB.PictureBox picSalida 
         ...
         Index           =   0
         Left            =   135
         Picture         =   "frmLibroIvaVentas.frx":002F
         ScaleHeight     =   240
         ScaleWidth      =   240
         TabIndex        =   15
         Top             =   315
      ...
      Begin VB.PictureBox picSalida 
         ...
         Index           =   1
         Left            =   135
         Picture         =   "frmLibroIvaVentas.frx":0131
         ScaleHeight     =   240
         ScaleWidth      =   240
         TabIndex        =   14
         Top             =   315
      ...
      Begin VB.PictureBox picSalida 
         ...
         Index           =   2
         Left            =   135
         Picture         =   "frmLibroIvaVentas.frx":0233
         ScaleHeight     =   240
         ScaleWidth      =   240
         TabIndex        =   13
         Top             =   315
   ...
   Begin VB.CommandButton cmdNuevo 
      Caption         =   "&Nuevo"
      DisabledPicture =   "frmLibroIvaVentas.frx":0335
      Height          =   405
      Left            =   3900
      TabIndex        =   3
      Top             =   2340
