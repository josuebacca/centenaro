    ...
    If Validar(vMode) = True Then
        ...
        Select Case vMode
            Case 1 'nuevo
                ...
                cSQL = cSQL & "     (FPG_CODIGO, FPG_DESCRI, FPG_PORCEN) "
                cSQL = cSQL & "VALUES "
                cSQL = cSQL & "     (" & XN(txtID.Text) & ", " & XS(txtDescri.Text) & ", " & XN(txtPorcentaje.Text) & ")"
            
            Case 2 'editar
                
                cSQL = "UPDATE " & cTabla & " SET "
                cSQL = cSQL & "     FPG_DESCRI = " & XS(txtDescri.Text)
                cSQL = cSQL & " ,FPG_PORCEN = " & XN(txtPorcentaje.Text)
    ...
    If vMode <> 1 Then
        If vFieldID <> "0" Then
            ...
            If (rec.BOF And rec.EOF) = 0 Then
                ...
                txtPorcentaje.Text = Format(Chk0(rec!FPG_PORCEN), "0.00")
            Else
                Beep
